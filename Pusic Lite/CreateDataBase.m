...
//    NSString * documentDirectory = [paths objectAtIndex:0];
    NSString *documentDirectory = [[NSBundle mainBundle] pathForResource:@"default" ofType:@"sqlite"];
    dataBaseFilePath = [documentDirectory stringByAppendingPathComponent:[PusicContant getDataBasePath]];
    NSLog(@"%@",documentDirectory);
    sqlite3 *sQ;
    if (sqlite3_open([documentDirectory UTF8String], &sQ) !=SQLITE_OK) {
        sqlite3_close(sQ);
    }
